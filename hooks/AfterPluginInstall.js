...
console.log('com-linkdev-eclinic-plugin AfterPluginInstall.js, attempting to modify build.xcconfig');
...
let pathToAdd = ' "$(SRCROOT)/$(PRODUCT_NAME)/com-linkdev-eclinic-plugin/"';
